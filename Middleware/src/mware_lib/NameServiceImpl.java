...
public class NameServiceImpl extends NameService {
    ...
    private Map<Integer, Object> servantMap = Collections.synchronizedMap(new HashMap<Integer, Object>());
    ...
    public void rebind(Object servant, String name) {
        ...
        logger.log(Level.INFO, "rebind mit servant= "+servant+", name= "+name+", Ref= "+reference);
    ...
    public Object resolve(String name) {
        logger.log(Level.INFO, "Resolve mit Name= "+name);
    ...
    public Object findServant(Reference servant){
        Object obj = servantMap.get(servant.hashCode());
        logger.log(Level.INFO,"findServant: servant= "+servant+", MapSize= "+servantMap.size()+", ReturnObj= "+obj);
        return obj;
    }
    ...
    private Reference addServant(Object servant, String name) {
        ...
        try {
            ...
            servantMap.put(reference.hashCode(),servant);
